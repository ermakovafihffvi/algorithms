...
class User
{
    ...
    /**
     * Функция чтобы использовать IdentityMap
     * $domainObjectName в данном случае это User
     */
    public function useIdentityMap(string $domainObjectName, int $objectId){
    ...
    {   
        if(!($this->useIdentityMap("User", $id))){
            ...
            return $this->useIdentityMap("User", $id);
        }
